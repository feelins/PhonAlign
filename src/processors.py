...
class CharsiuPreprocessor_zh(CharsiuPreprocessor_en):
    ...
    def __init__(self):
        ...
        tokenizer = Wav2Vec2CTCTokenizer.from_pretrained(pretrained_model_name_or_path=r'E:\003_ProgramLanguage\charsiu\pretrained_model\charsiu-tokenizer_zh_pinyin')
        feature_extractor = Wav2Vec2FeatureExtractor(feature_size=1, sampling_rate=16000, padding_value=0.0, do_normalize=True, return_attention_mask=False)
        self.processor = Wav2Vec2Processor(feature_extractor=feature_extractor, tokenizer=tokenizer)
        self.g2p = G2pM()
        self.sil = "[SIL]"
